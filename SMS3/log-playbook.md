...
8. identity evidence such as discovery `deviceId`, visible UI label, and relay snapshot timestamp
...
- When a mismatch repeats after one refresh, stop looping and switch evidence source.
- Never use old peers, old screenshots, or cached IDs as the next pairing target.
